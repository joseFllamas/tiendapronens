...
add_action('woocommerce_shipping_init', 'request_shipping_quote_method_28');

function request_shipping_quote_method_28() {
	if (!class_exists('WC_Distribucion_Internacional_Light')) {

		class WC_Distribucion_Internacional_Light extends WC_Shipping_Method {
...
add_filter('woocommerce_shipping_methods', 'add_request_shipping_quote_28');

function add_request_shipping_quote_28( $methods ) {

	$shippingMethod = CorreosOficialCommonShippingMethods::loadShippingMethod(WC_Distribucion_Internacional_Light::getPaqId());

	if ($shippingMethod) {
		$methods['request_shipping_quote_' . $shippingMethod[0]['id']] = 'WC_Distribucion_Internacional_Light';
	}
