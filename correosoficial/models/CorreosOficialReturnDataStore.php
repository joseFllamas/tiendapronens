...
class CorreosOficialReturnDataStore extends WC_Data_Store_WP {
	...
	public function __construct() {
		global $wpdb;
		$this->wpdb  = $wpdb;
		$this->table = $wpdb->prefix . 'correos_oficial_returns';
	}
	...
	public function get_all() {
		...
		if ($results) {
			...
			foreach ($results as $row) {
				$order = new CorreosOficialReturn(); // Asumiendo que tienes una clase Order para representar un pedido
