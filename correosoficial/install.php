...
$sql[] = $insert . CorreosOficialUtils::getPrefix() . "correos_oficial_products (
...
$sql[] = $create . CorreosOficialUtils::getPrefix() . 'correos_oficial_postcodes (
    ...
    // Tabla que guarda el historial de los pedidos
$sql[] = $create . CorreosOficialUtils::getPrefix() . "correos_oficial_sga_orders_log (
    id          int(11)         NOT NULL AUTO_INCREMENT,
...
// Tabla que guarda el estado actual de los pedidos<
$sql[] = $create . CorreosOficialUtils::getPrefix() . "correos_oficial_sga_orders_status (
        id              int(11)         NOT NULL AUTO_INCREMENT,
        order_id        int(11)         NOT NULL,
