-- Estructura completa de instalación según install.php
-- Generado: 2026-02-20 10:55:41
-- Este archivo contiene CREATE TABLE, INSERT y otros statements de instalación

-- =============================================
-- CREATE TABLE STATEMENTS
-- =============================================

-- Tabla: correos_oficial_configuration
CREATE TABLE `{PREFIX}correos_oficial_configuration` (
...
CREATE TABLE `{PREFIX}correos_oficial_senders` (
  ...
  KEY `idx_correos_oficial_senders_id` (`id`),
  KEY `idx_correos_oficial_senders_sender_default` (`sender_default`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

-- Tabla: correos_oficial_codes
CREATE TABLE `{PREFIX}correos_oficial_codes` (
  ...
  `CorreosClientID` varchar(50) NOT NULL,
  `CorreosSecretID` varchar(255) NOT NULL,
...
-- Tabla: correos_oficial_codes_actives
CREATE TABLE `{PREFIX}correos_oficial_codes_actives` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `company` varchar(7) DEFAULT NULL,
...
-- Tabla: correos_oficial_orders
CREATE TABLE `{PREFIX}correos_oficial_orders` (
  ...
  KEY `idx_correos_oficial_orders_id_order` (`id_order`),
  KEY `idx_correos_oficial_orders_shipping_number` (`shipping_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Tabla: correos_oficial_saved_orders
CREATE TABLE `{PREFIX}correos_oficial_saved_orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_order` int(11) NOT NULL,
  `shipping_number` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_correos_oficial_saved_orders_exp_number` (`exp_number`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

-- Tabla: correos_oficial_returns
CREATE TABLE `{PREFIX}correos_oficial_returns` (
  `id_order` int(11) NOT NULL,
  `id_sender` int(11) NOT NULL,
...
-- Tabla: correos_oficial_saved_returns
CREATE TABLE `{PREFIX}correos_oficial_saved_returns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_order` int(11) NOT NULL,
  `shipping_number` varchar(255) NOT NULL,
  `exp_number` varchar(100) NOT NULL,
...
-- Tabla: correos_oficial_pickups_returns
CREATE TABLE `{PREFIX}correos_oficial_pickups_returns` (
  `id_order` int(11) NOT NULL,
  `pickup_number` varchar(50) DEFAULT NULL,
  `pickup_date` date DEFAULT NULL,
  `pickup_from_hour` time DEFAULT NULL,
...
-- Tabla: correos_oficial_products
CREATE TABLE `{PREFIX}correos_oficial_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_correos_oficial_products_id` (`id`),
  KEY `idx_correos_oficial_products_id_carrier` (`id_carrier`),
  KEY `idx_correos_oficial_products_company` (`company`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

-- Tabla: correos_oficial_carriers_products
CREATE TABLE `{PREFIX}correos_oficial_carriers_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_carrier` int(11) NOT NULL,
  `id_product` int(11) NOT NULL,
...
-- Tabla: correos_oficial_customs_description
CREATE TABLE `{PREFIX}correos_oficial_customs_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Tabla: correos_oficial_requests
CREATE TABLE `{PREFIX}correos_oficial_requests` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_correos_oficial_requests_id_cart` (`id_cart`),
  KEY `idx_correos_oficial_requests_reference_code` (`reference_code`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

-- Tabla: correos_oficial_shipping_method_rules
CREATE TABLE `{PREFIX}correos_oficial_shipping_method_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Tabla: correos_oficial_sga_orders_log
CREATE TABLE `{PREFIX}correos_oficial_sga_orders_log` (
  `id` int(11)         NOT NULL AUTO_INCREMENT,
...
-- Tabla: correos_oficial_sga_orders_status
CREATE TABLE `{PREFIX}correos_oficial_sga_orders_status` (
  `id` int(11)         NOT NULL AUTO_INCREMENT,
  `order_id` int(11)         NOT NULL,
  `status` varchar(100)    NOT NULL DEFAULT '',
  `timestamp` TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
  `shipping_number` VARCHAR(255) DEFAULT '',
  `company_transport` int(11)       NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `{PREFIX}correos_oficial_configuration` (name, value, type) VALUES
  ...
  ('Analitica_date', '2026-02-20 10:55:41', 'analitica'),
  ('CountryOriginByDefault', '', 'text'),
  ('CorreosModify', '1', 'select'),
  ('ActivateSGA', '', 'checkbox'),
  ('SGAOwner', '', 'text'),
  ('SGACustomer', '', 'text'),
  ('SGAStore', '', 'text'),
  ('SGAProcessStatus', '', 'select'),
  ('SGAUpdateStock', '', 'checkbox'),
  ('SGAOrderUpdateStock', '', 'checkbox'),
  ('SGAOrderStatusTracking', '', 'checkbox'),
  ('SGAOrderStatusTrackingDays', '20', 'number'),
  ('SGAOrderStatusTrackingPE', '', 'select'),
  ('SGAOrderStatusTrackingEX', '', 'select'),
  ('SGAOrderStatusTrackingError', '', 'select'),
  ('SGAOrderStatusTrackingCronInterval', '4', 'number'),
  ('SGAOrderStatusTrackingCronLastExecutionTime', '1970-01-01 00:00:00', 'datetime'),
  ('SGAStockCronInterval', '12', 'number'),
  ('SGAStockCronLastExecutionTime', '1970-01-01 00:00:00', 'datetime'),
  ('ShowShippingStatusProcess', NULL, 'checkbox'),
  ('ShipmentCanceled', 'wc-cancelled-cocex', 'select'),
  ('ShipmentDelivered', 'wc-delivered-cocex', 'select'),
  ('ShipmentInProgress', 'wc-inprogress-cocex', 'select'),
  ('ShipmentPreregistered', 'wc-prepared-cocex', 'select'),
  ('ShipmentReturned', 'wc-returned-cocex', 'select'),
  ('MappedHsFeature', '', 'select'),
  ('MappedOriginFeature', '', 'select'),
  ('UseModuleFeatures', '', 'checkbox'),
  ('ProductRadio', '', 'checkbox'),
  ('ActivateMarketplace', '', 'checkbox'),
  ('MarketplaceApiKeyId', '', 'text'),
  ('MarketplaceConsumerKey', '', 'text'),
  ('MarketplaceConsumerSecret', '', 'text'),
  ('MarketplaceOrderStatusSlug', '', 'text');

INSERT INTO `{PREFIX}correos_oficial_codes_actives` (id, company, active) VALUES
    (1, 'Correos', 0),
    (2, 'CEX', 0);

INSERT INTO `{PREFIX}correos_oficial_products` (
    id, code, mode, name, active, delay, company, url, codigoProducto, id_carrier, product_type, max_packages, max_weight
) VALUES
    ...
    (4, '', '', 'Paq Empresa 14', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '92', 0, NULL, 99, 40),
    ...
    (7, '', '', 'Islas Documentación', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '46', 0, NULL, 99, 40),
    (8, '', '', 'Islas Marítimo', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '79', 0, NULL, 99, 40),
    (9, '', '', 'Internacional Express', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '91', 0, 'international', 1, 40),
    (10, '', '', 'Internacional Estandard', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '90', 0, 'international', 1, 40),
    ...
    (15, 'PADXA', 'DOUAOF', 'Paq Premium Domicilio', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0235', 0, 'homedelivery', 10, 30),
    (16, 'PADXA', 'OFUAOF', 'Paq Premium Oficina Elegida', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0236', 0, 'office', 10, 30),
    (17, 'PADXA', 'CIUAOF', 'Paq Premium City Paq', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0176', 0, 'citypaq', 10, 30),
    (18, 'PAFXB', 'DOUAOF', 'Paq Estándar Domicilio', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0132', 0, 'homedelivery', 10, 30),
    (19, 'PAFXB', 'OFUAOF', 'Paq Estándar Oficina Elegida', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0133', 0, 'office', 10, 30),
    (20, 'PAFXB', 'CIUAOF', 'Paq Estándar City Paq', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0178', 0, 'citypaq', 10, 30),
    (21, 'PAGXC', 'BUUAOF', 'Paq Ligero', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0179', 0, 'homedelivery', 10, 2),
    (22, 'PAAXH', 'DOUAOF', 'Paq Premium Internacional', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0411', 0, 'international', 1, 30),
    (23, 'PAAXI', 'DOUAOF', 'Paq Estándar Internacional', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0410', 0, 'international', 1, 30),
    (24, 'PAGXJ', 'BUUAOF', 'Paq Light Internacional', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0360', 0, 'international', 1, 2),
    (25, '', '', 'Paq 24 Oficina Elegida', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '44', 0, 'office', 99, 30),
    (26, 'POAXAC', 'EXPORT', 'Carta Certificada Internacional', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0004', 0, 'international', 1, 2),
    (27, 'PAAXK', 'DOUAOF', 'Paquete Postal Económico Internacional', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0031', 0, 'international', 1, 2),
    (28, 'LQBUTOOF', 'BUUAOF', 'Distribución Internacional Light', 0, 'Envíos con Correos OFICIAL', 'Correos', 'https://www.correos.es/es/es/herramientas/localizador/envios/detalle?tracking-number=@', 'S0361', 0, 'international', 1, 2),
    (29, '', '', 'PaqPunto', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '18', 0, 'pudocex', 1, 15),
    (30, '', '', 'PaqEcommerce', 0, 'Envíos con Correos OFICIAL', 'CEX', 'https://s.correosexpress.com/c?n=@', '24', 0, '', 1, 15);

INSERT INTO `{PREFIX}correos_oficial_customs_description` (id, code, description) VALUES
