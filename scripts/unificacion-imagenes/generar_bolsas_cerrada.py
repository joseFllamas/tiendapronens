...
# -*- coding: utf-8 -*-
"""
Genera con Nano Banana una foto de cada bolsa de guarderia del CSV CERRADA
...
Uso (desde la raiz del proyecto):
  python3 scripts/unificacion-imagenes/generar_bolsas_cerrada.py
  # opcionales:
...
def main():
    ...
    ap.add_argument("--csv", default="salida_unificacion/bolsasguarderia.csv")
    ap.add_argument("--webroot", default="web")
    ap.add_argument("--out", default="salida_unificacion/bolsas_cerradas")
