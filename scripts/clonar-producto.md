...
La tanda es un bloque del array `$tandas`, al principio del script. Se copia uno y se cambian estos
campos. Lo demás lo pone el script solo.
...
# Crear
drush php:script scripts/clonar-producto.php -- --crear
```
...
- No cambia precios: copia los del origen, variación a variación.
